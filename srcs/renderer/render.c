...
/*   Updated: 2022/01/29 16:04:24 by plouvel          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	render(t_mlx *fdf)
{
	...
	vec3d.y = 0;
	while ((size_t) vec3d.y < fdf->data.nbr_lines)
	{
		vec3d.x = 0;
		while ((size_t) vec3d.x < fdf->data.elems_line)
		{
			...
			{
				if ((size_t) vec3d.x < fdf->data.elems_line - 1)
